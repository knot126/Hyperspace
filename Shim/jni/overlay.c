...
int HSOverlayMount_s(lua_State *script) {
...
int HSOverlayUnmount_s(lua_State *script) {
...
int HSEnableOverlay(lua_State *script) {
	lua_register(script, "HSOverlayMount", HSOverlayMount_s);
	lua_register(script, "HSOverlayUnmount", HSOverlayUnmount_s);
